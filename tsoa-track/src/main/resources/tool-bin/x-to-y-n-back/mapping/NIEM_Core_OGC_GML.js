var NIEM_Core_OGC_GML_Module_Factory = function () {
  var NIEM_Core_OGC_GML = {
    name: 'NIEM_Core_OGC_GML',
  ...
  return {
    NIEM_Core_OGC_GML: NIEM_Core_OGC_GML
  };
};
if (typeof define === 'function' && define.amd) {
  define([], NIEM_Core_OGC_GML_Module_Factory);
}
else {
  var NIEM_Core_OGC_GML_Module = NIEM_Core_OGC_GML_Module_Factory();
  if (typeof module !== 'undefined' && module.exports) {
    module.exports.NIEM_Core_OGC_GML = NIEM_Core_OGC_GML_Module.NIEM_Core_OGC_GML;
  }
  else {
    var NIEM_Core_OGC_GML = NIEM_Core_OGC_GML_Module.NIEM_Core_OGC_GML;
  }
}