...
#Conventions
  ...
  * namespace format: http://[organizational-domain]/[system-domain]/[domain-object]/[version] 
    * namespace is a URL that contains only lower-case letters
    * a hyphen seperates nouns, adjectives and other modifiers
    * example: `http://company.com/customer/customer-profile/2.0`
  * schema file name matches [domain-object]
    * upper-camel-case starts and seperates nouns, adjectives and other modifiers
    * example: `CustomerProfile.xsd`
  * namespace prefix label is composed of each first letter of the system and domain object namespace parts
    * example: `xmlns:ccp="http://company.com/customer/customer-profile/2.0/`
