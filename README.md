...
**schema-generator** generates XML Schema derived JSON schema components that support binding to Java classes.  
...
Since XML Schema is the source, **schema-generator** generates JSON schema that mostly reflects the source XML Schema.  Therefore, if the source XML Schema is well-described, comprehensive, and documented, generated JSON schema will also have similar characteristics.
