...
class Schema {
  ...
  getPropertyDefinition (definitionPropertyContainer) {
    ...
    class PropertyPrimitive {
      ...
      hasValidW3cXmlTypeSchemaDefinition (definitionReferenceName) {
      ...
      getTypeNameW3cXmlTypeSchemaDefinition (typeName) {
        ...
        if (typeof typeName != "undefined") {
          if (this.hasValidW3cXmlTypeSchemaDefinition (typeName))
            ...
            if (this.hasValidW3cXmlTypeSchemaDefinition (lowerCaseTypeName))
...
/*         function getValidW3cXmlTypeSchemaDefinition (definitionReferenceName) {
        ...
        if (typeof definitionObjectProperty.$ref != "undefined")
          w3cXmlTypeSchemaDefinition = this.getTypeNameW3cXmlTypeSchemaDefinition(SchemaComponent.getDefinitionReferenceName(definitionObjectProperty))
        else
          if (typeof definitionObjectProperty.allOf != "undefined") {
            ...
            definitionObjectProperty.allOf.some( function (definitionObjectPropertyAllOfItem) {
              if (typeof definitionObjectPropertyAllOfItem.$ref != "undefined") {
                ...
                w3cXmlTypeSchemaDefinition = this.getTypeNameW3cXmlTypeSchemaDefinition (definitionReferenceName);
                  ...
                  if (typeof definitionObjectPropertyAllOfItem.items != "undefined") {
                    if (typeof definitionObjectPropertyAllOfItem.items.properties != "undefined") {
                      if (typeof definitionObjectPropertyAllOfItem.items.properties.value != "undefined") {
                        ...
                        if (this.validW3cXmlTypeSchemaDefinition(definitionReferenceName)) {
      ...
      setType (definitionObjectProperty, propertyName, propertySourceContent) {
        ...
        if (typeof definitionReferenceName != "undefined") {
          ...
          049a */
        //050 var w3cXmlTypeSchemaDefinition = this.getW3cXmlTypeSchemaDefinition(definitionObjectProperty);
        var w3cXmlTypeSchemaDefinition;
        if (typeof definitionObjectProperty.propertyType != "undefined")
           switch (definitionObjectProperty.propertyType) {
            case "element" :
              if (propertySourceContent.facets.length > 0)
                if (typeof propertySourceContent.facets[0].baseType != "undefined") {
                  ...
                  w3cXmlTypeSchemaDefinition = this.getTypeNameW3cXmlTypeSchemaDefinition(sourceContentBaseType);
                }
              break;
            case "attribute" :
              ...
              break;
            default :
              w3cXmlTypeSchemaDefinition = this.getW3cXmlTypeSchemaDefinition(definitionObjectProperty)
          };
        if (typeof w3cXmlTypeSchemaDefinition != "undefined") {
      ...
      setFacets (definitionObjectProperty, sourceContent) {
...
/* 049a        }
  ...
  getDescription () {
    ...
    if (typeof this.schemaComponent.sourceContent != "undefined")
      ...
      var description = this.schemaComponent.sourceContent.documentation.join("  ");
