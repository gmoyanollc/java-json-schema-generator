...
/* 049a        }
  ...
  getDescription () {
    ...
    if (typeof this.schemaComponent.sourceSchema.sourceContent != "undefined")
      if ((typeof this.schemaComponent.sourceSchema.sourceContent.components[this.schemaComponent.name] != "undefined") && (typeof this.schemaComponent.sourceSchema.sourceContent.components[this.schemaComponent.name].documentation != "undefined"))
        var description = this.schemaComponent.sourceSchema.sourceContent.components[this.schemaComponent.name].documentation.join("  ");
