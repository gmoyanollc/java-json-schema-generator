...
//var config = require("../.config-dev-vmf.js").config;
...
class ConfigDerived {
  constructor () {
    ...
    //049a this.schemaTemplateObjects = []; 
    this.w3cXmlTypeSchema = {}
  }

  //static getSchemaTemplateObjects () {
  /* 049a setSchemaTemplateObjects () {
    var schemaTemplateObjects = [];
    
    config.default.schemaTemplates.forEach(function (schemaTemplate) {
  ...
  setW3cXmlTypeSchema () { 
    ...
    if (typeof w3cXmlTypeSchemaFileBuffer != "undefined")
      return(JSON.parse(w3cXmlTypeSchemaFileBuffer))
    else 
...
class Schema {
  ...
  getFacets (definitionObjectProperty) {
    let facets = {};
  ...
  getPropertyDefinition (definitionPropertyContainer) {
    ...
    class PropertyPrimitive {
      ...
      getW3cXmlTypeSchemaDefinition (definitionObjectProperty) {

        function getValidW3cXmlTypeSchemaDefinition (definitionReferenceName) {
          ...
          var validW3cXmlTypeSchemaDefinition;
          if (typeof definitionReferenceName != "undefined") {
            if (hasValidW3cXmlTypeSchemaDefinition (definitionReferenceName))
              validW3cXmlTypeSchemaDefinition = config.derived.w3cXmlTypeSchema.definitions[definitionReferenceName]
            else {
              var lowerCaseDefinitionReferenceName = definitionReferenceName.charAt(0).toLowerCase() + definitionReferenceName.slice(1);
              if (hasValidW3cXmlTypeSchemaDefinition (lowerCaseDefinitionReferenceName))
                validW3cXmlTypeSchemaDefinition = config.derived.w3cXmlTypeSchema.definitions[lowerCaseDefinitionReferenceName]
            }
          }
          return(validW3cXmlTypeSchemaDefinition);
        }
       
        var w3cXmlTypeSchemaDefinition;
        var definitionReferenceName;
        if (typeof definitionObjectProperty.$ref != "undefined")
          w3cXmlTypeSchemaDefinition = getValidW3cXmlTypeSchemaDefinition(SchemaComponent.getDefinitionReferenceName(definitionObjectProperty))
        else
          if (typeof definitionObjectProperty.allOf != "undefined") {
            ...
            definitionObjectProperty.allOf.some( function (definitionObjectPropertyAllOfItem) {
              if (typeof definitionObjectPropertyAllOfItem.$ref != "undefined") {
                definitionReferenceName = SchemaComponent.getDefinitionReferenceName(definitionObjectPropertyAllOfItem);
                w3cXmlTypeSchemaDefinition = getValidW3cXmlTypeSchemaDefinition (definitionReferenceName);
                if (typeof w3cXmlTypeSchemaDefinition != "undefined") 
                  return(true);
              } else 
                if (typeof definitionObjectPropertyAllOfItem.properties != "undefined") {
                  if (typeof definitionObjectPropertyAllOfItem.properties.value != "undefined")
                    if (typeof definitionObjectPropertyAllOfItem.properties.value.allOf != "undefined")

                      definitionObjectPropertyAllOfItem.properties.value.allOf.some( function (definitionObjectPropertyAllOfItemPropertiesValueAllOfItem) {
                        definitionReferenceName = SchemaComponent.getDefinitionReferenceName(definitionObjectPropertyAllOfItemPropertiesValueAllOfItem.$ref);
                        w3cXmlTypeSchemaDefinition = getValidW3cXmlTypeSchemaDefinition (definitionReferenceName);
                        if (typeof w3cXmlTypeSchemaDefinition != "undefined") 
                          return(true);
                      }, this);
                      ...
                      definitionReferenceName = SchemaComponent.getDefinitionReferenceName( definitionObjectPropertyAllOfItem.properties.value);
                      w3cXmlTypeSchemaDefinition = getValidW3cXmlTypeSchemaDefinition (definitionReferenceName);
                      if (typeof w3cXmlTypeSchemaDefinition != "undefined") 
                        return(true);
                    }
                } else {
                  if (typeof definitionObjectPropertyAllOfItem.items != "undefined") {
                    if (typeof definitionObjectPropertyAllOfItem.items.properties != "undefined") {
                      if (typeof definitionObjectPropertyAllOfItem.items.properties.value != "undefined") {
                      ...
                      definitionReferenceName = SchemaComponent.getDefinitionReferenceName( definitionObjectPropertyAllOfItem.items);
                      w3cXmlTypeSchemaDefinition = getValidW3cXmlTypeSchemaDefinition (definitionReferenceName);
                      if (typeof w3cXmlTypeSchemaDefinition != "undefined") 
                        return(true);
                    }
            ...
            w3cXmlTypeSchemaDefinition = SchemaComponent.getDefinitionReferenceName(definitionObjectProperty);*/
        return(w3cXmlTypeSchemaDefinition);
      }

      setType (definitionObjectProperty) {
        /* 049a var definitionReferenceName = SchemaComponent.getDefinitionReferenceName(definitionObjectProperty);
        if (typeof definitionReferenceName != "undefined") {
          var w3cXmlTypeSchemaDefinition;
          if (typeof config.derived.w3cXmlTypeSchema.definitions[definitionReferenceName] != "undefined")
            if ((typeof config.derived.w3cXmlTypeSchema.definitions[definitionReferenceName].type != "undefined") || (typeof config.derived.w3cXmlTypeSchema.definitions[definitionReferenceName].anyOf != "undefined")) 
            ...
            var lowerCaseDefinitionReferenceName = definitionReferenceName.charAt(0).toLowerCase() + definitionReferenceName.slice(1);
            if (typeof config.derived.w3cXmlTypeSchema.definitions[lowerCaseDefinitionReferenceName] != "undefined")
              w3cXmlTypeSchemaDefinition = config.derived.w3cXmlTypeSchema.definitions[lowerCaseDefinitionReferenceName];
          //049a if ((typeof w3cXmlTypeSchemaDefinition != "undefined") || (w3cXmlTypeSchemaDefinition != "")) {
          049a */
        var w3cXmlTypeSchemaDefinition = this.getW3cXmlTypeSchemaDefinition(definitionObjectProperty);
        if (typeof w3cXmlTypeSchemaDefinition != "undefined") {
          if (typeof w3cXmlTypeSchemaDefinition.type != "undefined")
            ...
            if (typeof w3cXmlTypeSchemaDefinition.anyOf != "undefined") {
              this.anyOf = w3cXmlTypeSchemaDefinition.anyOf;
              ...
              //w3cXmlTypeSchemaDefinition.anyOf.forEach(function (w3cXmlTypeSchemaDefinitionAnyOfItem) {
                //if (typeof w3cXmlTypeSchemaDefinitionAnyOfItem.type != "undefined") {
                  ...
                  /*049a if (typeof this.type != "undefined") {
                    if (this.type == "array")
                      console.log("  INFO: anyOf type ignored: " + w3cXmlTypeSchemaDefinitionAnyOfItem)             
                  else 049a*/
                    //049a propertyPrimitiveTemplate.type.push(w3cXmlTypeSchemaDefinitionAnyOfItem.type); 
                  //this.type.push(w3cXmlTypeSchemaDefinitionAnyOfItem.type);
                //}
              //}, this)
          ...
          console.log("  WARNING: PropertyPrimitive.Type undefined");
        //049a }
      }
...
/* 049a        }
    ...
    function getPropertyReference (schemaComponent, definitionPropertyItem) {
      ...
      if ((typeof schemaComponent.sourceSchema.fileObject.definitions != "undefined")
        ...
        referenceSchemaComponent = new SchemaComponent(remoteDefinitionSource.definition, remoteDefinitionSource.sourceSchema, schemaComponent.config);
      };
      if (referenceSchemaComponent.hasMappedSourceSchema(referenceName)) {
        referenceSchemaComponent.generateSchema();
        propertyReference = { "$ref": schemaComponent.sourceSchema.baseDirRelativeDepth + referenceSchemaComponent.schemaFileDestination };
      } else {
    ...
    for (var definitionPropertyItemName in definitionPropertyContainer) {
      ...
      switch (propertyTemplateType) {
        case 'array':
          ...
          propertyArray.setFacet(definitionPropertyItem);
        ...
        case 'primitive':
          ...
          //049c else
          propertyPrimitive.setType(definitionPropertyItem);
          //propertyPrimitive.setFacet(definitionPropertyItem);
          propertyPrimitive.setEnum(definitionPropertyItem);
  ...
  /* 049a getVersion () {
    ...
    console.log("  version: " + config.mapping.targetSchemaBuildVersion);
    return (config.mapping.targetSchemaBuildVersion);
  } 049a */
  ...
  getDescription () {
    ...
    if (typeof this.schemaComponent.sourceSchema.documentation != "undefined")
  ...
  /* 049a getSchemaTemplateObject (templateId) {
  ...
  getObject () {
    this.schemaObject = {};
    //049a this.schemaObject = this.getSchemaTemplateObject("schema-template");
    ...
    //049b this.schemaObject.type = this.getType();
    this.schemaObject.description = this.getDescription();
    //049a this.schemaObject.version = this.getVersion();
    ...
    //048 };
    this.schemaObject = Object.assign(this.schemaObject, this.getFacets(this.schemaComponent.definition));
...
class SchemaComponent {
  ...
  //if (typeof schemaObject != "undefined") {
    ...
    //else var relativeDestination = this.targetSchemaBaseDir + schemaFileDestination;
      ...
      relativeDestination = this.config.mapping.schemaBaseDir.target + this.schemaFileDestination;
  ...
  setIdentifier () {
    ...
    //049b throw ("  ERROR: unable to determine from namespace and name values: " + this.namespace + '#' + this.name);
  ...
  setName () {
    ...
    if (typeof propertyObjectIdentifierContainer != "undefined") {
      if (typeof propertyObjectIdentifierContainer.localPart != "undefined")
        ...
        //049b throw ("  ERROR: unable to determine name");
  ...
  setNamespace () {
    ...
    if (typeof propertyObjectIdentifierContainer != "undefined") {
      ...
      //049b throw ("  ERROR: Unable to setNamespace with propertyObjectIdentifierContainer:" + propertyObjectIdentifierContainer);
  ...
  static getRemoteDefinitionSource (definitionObjectIdentifier) {
    ...
    function getDefinitionSourceSchemaFile (definitionObjectIdentifier) {
      ...
      //049b var definitionObjectIdentifierNamespace = definitionObjectIdentifier.substring(0, definitionObjectIdentifier.indexOf('#'));
        ...
        for (var index = 0; index < config.mapping.schemaFilepathMappings.length; index++) {
          if ((config.mapping.schemaFilepathMappings[index].sourceSchemaFileId === definitionObjectIdentifierNamespace) || (config.mapping.schemaFilepathMappings[index].sourceSchemaFileId === definitionObjectIdentifierNamespace + '#'))
            if (config.mapping.schemaFilepathMappings[index].sourceSchemaFileId != '#') {
              ...
              //049b throw "  ERROR: Schema namespace was matched but definition was not found in source schema file.";
      ...
      //049b if (definitionObjectIdentifierNamespace == "")
        //049b throw "  ERROR: Schema namespace was not matched for a definition source schema file location.";
    ...
    if (typeof sourceSchema.fileObject != "undefined") {
      sourceSchema.setBaseDirRelativeDepth(config.mapping.schemaFilepathMappings);
      sourceSchema.setDocumentation(config.mapping.schemaFilepathMappings, config.mapping.sourceDocumentationBaseDir);
        ...
        for (var index = 0; index < config.schemaFilepathMappings.length; index++) {
          if (config.schemaFilepathMappings[index].namespace === namespace) {
            if (sourceSchema.namespace === namespace)
              ...
              schemaFileDestination = sourceSchema.baseDirRelativeDepth + config.mapping.schemaFilepathMappings[index].targetSchemaFilepath + name + ".json";
            break;
          };
        };
  ...
  setDocumentation (schemaFilepathMappings, sourceDocumentationBaseDir) {
    ...
    try {
      ...
      for (var index = 0; index < schemaFilepathMappings.length; index++) {
        if (schemaFilepathMappings[index].namespace === this.namespace) { 
          if ( schemaFilepathMappings[index].sourceDocumentationFilename !== "" ) {
            ...
            if (typeof sourceDocumentationBuffer != "undefined")
              this.documentation = JSON.parse(sourceDocumentationBuffer)
            else
              console.log("  WARNING: nothing to parse for " + sourceDocumentationBaseDir + schemaFilepathMappings[index].sourceDocumentationFilepath + schemaFilepathMappings[index].sourceDocumentationFilename);
          } else {
      ...
      if ( typeof this.documentation == "undefined" ) 
        throw("  WARNING: unable to setSourceDocumentation for namespace: " + this.namespace);
      } else throw("  WARNING: unable to setSourceDocumentation for namespace: " + this.namespace);
...
*/
  ...
  // 049a config.derived.schemaTemplateObjects = config.derived.setSchemaTemplateObjects();
  ...
  if (typeof config.derived.w3cXmlTypeSchema != "undefined") {
    ...
    if (typeof sourceSchema.fileObject.anyOf != "undefined") {
      ...
      sourceSchema.fileObject.anyOf.forEach(function (sourceSchemaFileObjectAnyOfItem) {
        ...
        var schemaComponent = new SchemaComponent(sourceSchemaFileObjectAnyOfItem, sourceSchema, config);
...
// 046b replaced by getProperty
// 049 SchemaGenerator.prototype.getComponentSchemaProperty = function (sourceSchemaObject, definitionPropertyContainer) {
/* 046d
  function getPropertyTemplateType (definitionObjectProperty) {
    console.log('####getting PropertyTemplateType for: ' + definitionObjectProperty.title);
    console.log('####Is definitionObjectProperty type defined?');
...
046d */
  /*049 console.log("##### getComponentSchemaProperty");
  let property = {};

  for (var definitionPropertyName in definitionPropertyContainer) {
    console.log("  getProperty: " + definitionPropertyName);049*/
    ...
    /*049var componentSchemaPropertyDefinition = this.getComponentSchemaPropertyDefinition(sourceSchemaObject, definitionPropertyContainer);
    if ( definitionPropertyName == "$ref" ) {
