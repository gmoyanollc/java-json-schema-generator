...
public class niem_niem_core_3_0_DateRangeType {
    ...
    public<T >T get(String name) {
        Object value = declaredPropertyOrNotFound(name, niem_niem_core_3_0_DateRangeType.NOT_FOUND_VALUE);
        if (niem_niem_core_3_0_DateRangeType.NOT_FOUND_VALUE!= value) {
            return ((T) value);
        } else {
        ...
        for(String schema : schemaArray)
{
 schemaString = schemaString.concat(schema); 
     ...
     */
    public static niem_niem_core_3_0_DateRangeType fromString(String s) {
        try {
            ObjectMapper objectMapper = new ObjectMapper();
            return objectMapper.readValue(s, niem_niem_core_3_0_DateRangeType.class);
