...
public class LatitudeDegreeValue {
    ...
    public<T >T get(String name) {
        Object value = declaredPropertyOrNotFound(name, LatitudeDegreeValue.NOT_FOUND_VALUE);
        if (LatitudeDegreeValue.NOT_FOUND_VALUE!= value) {
            return ((T) value);
        } else {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LatitudeDegreeValue) == false) {
            return false;
        }
        LatitudeDegreeValue rhs = ((LatitudeDegreeValue) other);
        ...
        for(String schema : schemaArray)
{
 schemaString = schemaString.concat(schema); 
     ...
     */
    public static LatitudeDegreeValue fromString(String s) {
        try {
            ObjectMapper objectMapper = new ObjectMapper();
            return objectMapper.readValue(s, LatitudeDegreeValue.class);
