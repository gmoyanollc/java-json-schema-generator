...
public class LocationHeightVerticalDatumCode {
    ...
    @Valid
    private niem.codes.nga.datum._3_0.VerticalDatumCodeType VerticalDatumCodeType;
     ...
     */
    @JsonProperty("VerticalDatumCodeType")
    public niem.codes.nga.datum._3_0.VerticalDatumCodeType getVerticalDatumCodeType() {
     ...
     */
    @JsonProperty("VerticalDatumCodeType")
    public void setVerticalDatumCodeType(niem.codes.nga.datum._3_0.VerticalDatumCodeType VerticalDatumCodeType) {
    ...
    protected boolean declaredProperty(String name, Object value) {
        if ("VerticalDatumCodeType".equals(name)) {
            if (value instanceof niem.codes.nga.datum._3_0.VerticalDatumCodeType) {
                setVerticalDatumCodeType(((niem.codes.nga.datum._3_0.VerticalDatumCodeType) value));
            } else {
                throw new IllegalArgumentException(("property \"VerticalDatumCodeType\" is of type \"niem.codes.nga.datum._3_0.VerticalDatumCodeType\", but got "+ value.getClass().toString()));
            }
            return true;
        } else {
            return false;
