...
public class USMTFEnvironmentCategoryCodeType {
    ...
    public<T >T get(String name) {
        Object value = declaredPropertyOrNotFound(name, USMTFEnvironmentCategoryCodeType.NOT_FOUND_VALUE);
        if (USMTFEnvironmentCategoryCodeType.NOT_FOUND_VALUE!= value) {
            return ((T) value);
        } else {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof USMTFEnvironmentCategoryCodeType) == false) {
            return false;
        }
        ...
        for(String schema : schemaArray)
{
 schemaString = schemaString.concat(schema); 
     ...
     */
    public static USMTFEnvironmentCategoryCodeType fromString(String s) {
        try {
            ObjectMapper objectMapper = new ObjectMapper();
            return objectMapper.readValue(s, USMTFEnvironmentCategoryCodeType.class);
