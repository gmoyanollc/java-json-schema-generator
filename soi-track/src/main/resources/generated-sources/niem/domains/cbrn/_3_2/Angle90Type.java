...
public class Angle90Type {
    ...
    private final static String[] schemaArray = new String[] {"{\"$schema\":\"http://json-schema.org/draft-04/schema#\",\"id\":\"http://release.niem.gov/niem/domains/cbrn/3.2/#Angle90Type\",\"title\":\"Angle90Type\",\"type\":\"object\",\"description\":\"A data type for an inclination measure where the units are decimal degrees and the values range from +90.0 to -90.0.\",\"version\":\"0.4.5\",\"javaType\":\"niem.domains.cbrn._3_2.Angle90Type\",\"properties\":{\"value\":{\"type\":[\"number\",\"null\"],\"description\":\"http://www.w3.org/TR/xmlschema-2/#decimal\",\"maximum\":2147483647,\"minimum\":-2147483648},\"unitsText\":{\"type\":\"string\",\"description\":\"http://www.w3.org/TR/xmlschema-2/#normalizedString\",\"maxLength\":128}},\"additionalProperties\":false}", ""};
    ...
    public<T >T get(String name) {
        Object value = declaredPropertyOrNotFound(name, Angle90Type.NOT_FOUND_VALUE);
        if (Angle90Type.NOT_FOUND_VALUE!= value) {
            return ((T) value);
        } else {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Angle90Type) == false) {
            return false;
        }
        Angle90Type rhs = ((Angle90Type) other);
        ...
        for(String schema : schemaArray)
{
 schemaString = schemaString.concat(schema); 
     ...
     */
    public static Angle90Type fromString(String s) {
        try {
            ObjectMapper objectMapper = new ObjectMapper();
            return objectMapper.readValue(s, Angle90Type.class);
