...
public class ElevationMeasure {
    ...
    public<T >T get(String name) {
        Object value = declaredPropertyOrNotFound(name, ElevationMeasure.NOT_FOUND_VALUE);
        if (ElevationMeasure.NOT_FOUND_VALUE!= value) {
            return ((T) value);
        } else {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElevationMeasure) == false) {
            return false;
        }
        ElevationMeasure rhs = ((ElevationMeasure) other);
        ...
        for(String schema : schemaArray)
{
 schemaString = schemaString.concat(schema); 
     ...
     */
    public static ElevationMeasure fromString(String s) {
        try {
            ObjectMapper objectMapper = new ObjectMapper();
            return objectMapper.readValue(s, ElevationMeasure.class);
