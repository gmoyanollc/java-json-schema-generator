...
public class SystemIdentificationType {
                ...
                if ("IdentificationJurisdiction".equals(name)) {
                    ...
                    if ("IdentificationAugmentationPoint".equals(name)) {
                        ...
                        if ("SystemName".equals(name)) {
                            if (value instanceof List) {
                                setSystemName(((List<String> ) value));
                            } else {
                                throw new IllegalArgumentException(("property \"SystemName\" is of type \"java.util.List<java.lang.String>\", but got "+ value.getClass().toString()));
                            }
                            return true;
                        } else {
                            return false;
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(ObjectType).append(IdentificationID).append(IdentificationJurisdiction).append(IdentificationAugmentationPoint).append(SystemName).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(ObjectType, rhs.ObjectType).append(IdentificationID, rhs.IdentificationID).append(IdentificationJurisdiction, rhs.IdentificationJurisdiction).append(IdentificationAugmentationPoint, rhs.IdentificationAugmentationPoint).append(SystemName, rhs.SystemName).isEquals();
    }
    ...
    public static String[] getReferenceArray() {
        return new String[] {"IdentificationID.json", "../../../tsoa/soi/tsoa-track/2.0/ShortName.json", "IdentificationJurisdiction.json", "SystemName.json", "../../../../niem/niem-core/3.0/TextType.json", "LocationCountryName.json", "../../../niem/structures/3.0/ObjectType.json"};
    }
