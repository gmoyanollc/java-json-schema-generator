...
public class DirectionCodeType {
    ...
    public<T >T get(String name) {
        Object value = declaredPropertyOrNotFound(name, DirectionCodeType.NOT_FOUND_VALUE);
        if (DirectionCodeType.NOT_FOUND_VALUE!= value) {
            return ((T) value);
        } else {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DirectionCodeType) == false) {
            return false;
        }
        DirectionCodeType rhs = ((DirectionCodeType) other);
        ...
        for(String schema : schemaArray)
{
 schemaString = schemaString.concat(schema); 
     ...
     */
    public static DirectionCodeType fromString(String s) {
        try {
            ObjectMapper objectMapper = new ObjectMapper();
            return objectMapper.readValue(s, DirectionCodeType.class);
