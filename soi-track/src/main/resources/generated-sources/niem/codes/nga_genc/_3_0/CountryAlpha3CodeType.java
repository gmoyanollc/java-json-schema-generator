...
package niem.codes.nga_genc._3_0;
...
public class CountryAlpha3CodeType {
    ...
    private final static String[] schemaArray = new String[] {"{\"$schema\":\"http://json-schema.org/draft-04/schema#\",\"id\":\"http://release.niem.gov/niem/codes/nga_genc/3.0/#CountryAlpha3CodeType\",\"title\":\"CountryAlpha3CodeType\",\"type\":\"object\",\"description\":\"A data type for three-character country codes.\",\"version\":\"0.4.5\",\"javaType\":\"niem.codes.nga_genc._3_0.CountryAlpha3CodeType\",\"properties\":{\"type\":[\"string\",\"null\"],\"maxLength\":128},\"additionalProperties\":false}", ""};
    ...
    public<T >T get(String name) {
        Object value = declaredPropertyOrNotFound(name, CountryAlpha3CodeType.NOT_FOUND_VALUE);
        if (CountryAlpha3CodeType.NOT_FOUND_VALUE!= value) {
            return ((T) value);
        } else {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CountryAlpha3CodeType) == false) {
            return false;
        }
        CountryAlpha3CodeType rhs = ((CountryAlpha3CodeType) other);
        ...
        for(String schema : schemaArray)
{
 schemaString = schemaString.concat(schema); 
     ...
     */
    public static CountryAlpha3CodeType fromString(String s) {
        try {
            ObjectMapper objectMapper = new ObjectMapper();
            return objectMapper.readValue(s, CountryAlpha3CodeType.class);
