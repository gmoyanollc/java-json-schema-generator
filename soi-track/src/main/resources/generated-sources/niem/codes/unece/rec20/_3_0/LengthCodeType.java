...
package niem.codes.unece.rec20._3_0;
...
public class LengthCodeType {
    ...
    public<T >T get(String name) {
        Object value = declaredPropertyOrNotFound(name, LengthCodeType.NOT_FOUND_VALUE);
        if (LengthCodeType.NOT_FOUND_VALUE!= value) {
            return ((T) value);
        } else {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LengthCodeType) == false) {
            return false;
        }
        LengthCodeType rhs = ((LengthCodeType) other);
        ...
        for(String schema : schemaArray)
{
 schemaString = schemaString.concat(schema); 
     ...
     */
    public static LengthCodeType fromString(String s) {
        try {
            ObjectMapper objectMapper = new ObjectMapper();
            return objectMapper.readValue(s, LengthCodeType.class);
