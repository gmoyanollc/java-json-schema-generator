...
public class PlatformStandardIdentityCode {
    ...
    public<T >T get(String name) {
        Object value = declaredPropertyOrNotFound(name, PlatformStandardIdentityCode.NOT_FOUND_VALUE);
        if (PlatformStandardIdentityCode.NOT_FOUND_VALUE!= value) {
            return ((T) value);
        } else {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PlatformStandardIdentityCode) == false) {
            return false;
        }
        PlatformStandardIdentityCode rhs = ((PlatformStandardIdentityCode) other);
        ...
        for(String schema : schemaArray)
{
 schemaString = schemaString.concat(schema); 
     ...
     */
    public static PlatformStandardIdentityCode fromString(String s) {
        try {
            ObjectMapper objectMapper = new ObjectMapper();
            return objectMapper.readValue(s, PlatformStandardIdentityCode.class);
