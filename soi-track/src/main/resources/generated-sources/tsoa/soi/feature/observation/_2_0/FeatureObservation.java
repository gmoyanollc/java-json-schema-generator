...
public class FeatureObservation {
    ...
    public<T >T get(String name) {
        Object value = declaredPropertyOrNotFound(name, FeatureObservation.NOT_FOUND_VALUE);
        if (FeatureObservation.NOT_FOUND_VALUE!= value) {
            return ((T) value);
        } else {
        ...
        for(String schema : schemaArray)
{
 schemaString = schemaString.concat(schema); 
     ...
     */
    public static FeatureObservation fromString(String s) {
        try {
            ObjectMapper objectMapper = new ObjectMapper();
            return objectMapper.readValue(s, FeatureObservation.class);
