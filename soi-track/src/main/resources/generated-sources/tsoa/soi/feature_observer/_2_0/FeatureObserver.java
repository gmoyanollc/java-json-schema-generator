...
package tsoa.soi.feature_observer._2_0;
...
public class FeatureObserver {
    ...
    private final static String[] schemaArray = new String[] {"{\"$schema\":\"http://json-schema.org/draft-04/schema#\",\"id\":\"http://mcsc.usmc.mil/mc2sa/tsoa/soi/feature-observer/2.0/#FeatureObserver\",\"title\":\"FeatureObserver\",\"type\":\"object\",\"description\":\"A feature observer of something.\",\"version\":\"0.4.5\",\"javaType\":\"tsoa.soi.feature_observer._2_0.FeatureObserver\",\"properties\":{\"AugmentationType\":{\"$ref\":\"../../../../niem/structures/3.0/AugmentationType.json\"},\"Observer\":{\"$ref\":\"../../../../niem/domains/militaryOperationsRestricted/3.2/Observer.json\"}},\"additionalProperties\":false}", ""};
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(AugmentationType).append(Observer).toHashCode();
    }
