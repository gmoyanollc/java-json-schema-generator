...
public class ShortName {
    ...
    @Valid
    private niem.niem.core._3_0.TextType TextType;
     ...
     */
    @JsonProperty("TextType")
    public niem.niem.core._3_0.TextType getTextType() {
        return TextType;
    }
     ...
     */
    @JsonProperty("TextType")
    public void setTextType(niem.niem.core._3_0.TextType TextType) {
    ...
    protected boolean declaredProperty(String name, Object value) {
        if ("TextType".equals(name)) {
            if (value instanceof niem.niem.core._3_0.TextType) {
                setTextType(((niem.niem.core._3_0.TextType) value));
            } else {
                throw new IllegalArgumentException(("property \"TextType\" is of type \"niem.niem.core._3_0.TextType\", but got "+ value.getClass().toString()));
            }
            return true;
        } else {
            return false;
    ...
    public static String[] getReferenceSchemaArray() {
        return new String[] {"{\"$schema\":\"http://json-schema.org/draft-04/schema#\",\"id\":\"http://release.niem.gov/niem/niem-core/3.0/#TextType\",\"title\":\"TextType\",\"type\":\"object\",\"description\":\"A data type for a character string.\",\"version\":\"0.4.4\",\"javaType\":\"niem.niem.core._3_0.TextType\",\"properties\":{\"value\":{\"type\":\"string\"}},\"additionalProperties\":false}"};
    }
