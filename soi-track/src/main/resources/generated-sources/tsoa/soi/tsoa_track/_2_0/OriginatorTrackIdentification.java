...
public class OriginatorTrackIdentification {
    ...
    @Valid
    private niem.niem_core._3_0.IdentificationType IdentificationType;
     ...
     */
    @JsonProperty("IdentificationType")
    public niem.niem_core._3_0.IdentificationType getIdentificationType() {
     ...
     */
    @JsonProperty("IdentificationType")
    public void setIdentificationType(niem.niem_core._3_0.IdentificationType IdentificationType) {
    ...
    protected boolean declaredProperty(String name, Object value) {
        if ("IdentificationType".equals(name)) {
            if (value instanceof niem.niem_core._3_0.IdentificationType) {
                setIdentificationType(((niem.niem_core._3_0.IdentificationType) value));
            } else {
                throw new IllegalArgumentException(("property \"IdentificationType\" is of type \"niem.niem_core._3_0.IdentificationType\", but got "+ value.getClass().toString()));
            }
            return true;
        } else {
            return false;
    ...
    public static String[] getReferenceArray() {
        return new String[] {"IdentificationID.json", "../../../../niem/niem-core/3.0/IdentificationType.json", "../../../tsoa/soi/tsoa-track/2.0/ShortName.json", "IdentificationJurisdiction.json", "../../../../niem/niem-core/3.0/TextType.json", "LocationCountryName.json", "../../../niem/structures/3.0/ObjectType.json"};
    }
