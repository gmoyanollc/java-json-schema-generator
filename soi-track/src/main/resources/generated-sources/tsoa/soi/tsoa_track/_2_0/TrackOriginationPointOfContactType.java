...
/**
 * TrackOriginationPointOfContactType
 * <p>
 * A data type for a Track Origination Point-Of-Contact.
 * 
 */
...
public class TrackOriginationPointOfContactType {
    ...
    public<T >T get(String name) {
        Object value = declaredPropertyOrNotFound(name, TrackOriginationPointOfContactType.NOT_FOUND_VALUE);
        if (TrackOriginationPointOfContactType.NOT_FOUND_VALUE!= value) {
            return ((T) value);
        } else {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TrackOriginationPointOfContactType) == false) {
            return false;
        }
        TrackOriginationPointOfContactType rhs = ((TrackOriginationPointOfContactType) other);
        ...
        for(String schema : schemaArray)
{
 schemaString = schemaString.concat(schema); 
     ...
     */
    public static TrackOriginationPointOfContactType fromString(String s) {
        try {
            ObjectMapper objectMapper = new ObjectMapper();
            return objectMapper.readValue(s, TrackOriginationPointOfContactType.class);
