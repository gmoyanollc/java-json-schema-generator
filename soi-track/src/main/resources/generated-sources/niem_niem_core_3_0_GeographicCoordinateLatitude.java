...
public class niem_niem_core_3_0_GeographicCoordinateLatitude {
    ...
    @Valid
    private niem_niem_core_3_0_LatitudeDegreeValue LatitudeDegreeValue;
     ...
     */
    @JsonProperty("LatitudeDegreeValue")
    public niem_niem_core_3_0_LatitudeDegreeValue getLatitudeDegreeValue() {
     ...
     */
    @JsonProperty("LatitudeDegreeValue")
    public void setLatitudeDegreeValue(niem_niem_core_3_0_LatitudeDegreeValue LatitudeDegreeValue) {
    ...
    protected boolean declaredProperty(String name, Object value) {
        if ("LatitudeDegreeValue".equals(name)) {
            if (value instanceof niem_niem_core_3_0_LatitudeDegreeValue) {
                setLatitudeDegreeValue(((niem_niem_core_3_0_LatitudeDegreeValue) value));
            } else {
                throw new IllegalArgumentException(("property \"LatitudeDegreeValue\" is of type \"niem_niem_core_3_0_LatitudeDegreeValue\", but got "+ value.getClass().toString()));
            }
            return true;
        } else {
            return false;
    ...
    public<T >T get(String name) {
        Object value = declaredPropertyOrNotFound(name, niem_niem_core_3_0_GeographicCoordinateLatitude.NOT_FOUND_VALUE);
        if (niem_niem_core_3_0_GeographicCoordinateLatitude.NOT_FOUND_VALUE!= value) {
            return ((T) value);
        } else {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof niem_niem_core_3_0_GeographicCoordinateLatitude) == false) {
            return false;
        }
        niem_niem_core_3_0_GeographicCoordinateLatitude rhs = ((niem_niem_core_3_0_GeographicCoordinateLatitude) other);
        ...
        for(String schema : schemaArray)
{
 schemaString = schemaString.concat(schema); 
     ...
     */
    public static niem_niem_core_3_0_GeographicCoordinateLatitude fromString(String s) {
        try {
            ObjectMapper objectMapper = new ObjectMapper();
            return objectMapper.readValue(s, niem_niem_core_3_0_GeographicCoordinateLatitude.class);
