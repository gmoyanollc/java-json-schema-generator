...
public class niem_niem_core_3_0_ContactRadio {
    ...
    public<T >T get(String name) {
        Object value = declaredPropertyOrNotFound(name, niem_niem_core_3_0_ContactRadio.NOT_FOUND_VALUE);
        if (niem_niem_core_3_0_ContactRadio.NOT_FOUND_VALUE!= value) {
            return ((T) value);
        } else {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof niem_niem_core_3_0_ContactRadio) == false) {
            return false;
        }
        niem_niem_core_3_0_ContactRadio rhs = ((niem_niem_core_3_0_ContactRadio) other);
        ...
        for(String schema : schemaArray)
{
 schemaString = schemaString.concat(schema); 
     ...
     */
    public static niem_niem_core_3_0_ContactRadio fromString(String s) {
        try {
            ObjectMapper objectMapper = new ObjectMapper();
            return objectMapper.readValue(s, niem_niem_core_3_0_ContactRadio.class);
