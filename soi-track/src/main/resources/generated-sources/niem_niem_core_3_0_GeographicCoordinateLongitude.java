...
public class niem_niem_core_3_0_GeographicCoordinateLongitude {
     ...
     */
    @JsonProperty("LongitudeDegreeValue")
    public niem_niem_core_3_0_LongitudeDegreeValue getLongitudeDegreeValue() {
     ...
     */
    @JsonProperty("LongitudeDegreeValue")
    public void setLongitudeDegreeValue(niem_niem_core_3_0_LongitudeDegreeValue LongitudeDegreeValue) {
    ...
    protected boolean declaredProperty(String name, Object value) {
        if ("LongitudeDegreeValue".equals(name)) {
            if (value instanceof niem_niem_core_3_0_LongitudeDegreeValue) {
                setLongitudeDegreeValue(((niem_niem_core_3_0_LongitudeDegreeValue) value));
            } else {
                throw new IllegalArgumentException(("property \"LongitudeDegreeValue\" is of type \"niem_niem_core_3_0_LongitudeDegreeValue\", but got "+ value.getClass().toString()));
            }
            return true;
        } else {
            return false;
    ...
    public<T >T get(String name) {
        Object value = declaredPropertyOrNotFound(name, niem_niem_core_3_0_GeographicCoordinateLongitude.NOT_FOUND_VALUE);
        if (niem_niem_core_3_0_GeographicCoordinateLongitude.NOT_FOUND_VALUE!= value) {
            return ((T) value);
        } else {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof niem_niem_core_3_0_GeographicCoordinateLongitude) == false) {
            return false;
        }
        niem_niem_core_3_0_GeographicCoordinateLongitude rhs = ((niem_niem_core_3_0_GeographicCoordinateLongitude) other);
        ...
        for(String schema : schemaArray)
{
 schemaString = schemaString.concat(schema); 
     ...
     */
    public static niem_niem_core_3_0_GeographicCoordinateLongitude fromString(String s) {
        try {
            ObjectMapper objectMapper = new ObjectMapper();
            return objectMapper.readValue(s, niem_niem_core_3_0_GeographicCoordinateLongitude.class);
