...
public class niem_domains_militaryOperations_3_2_ObservationOPEXCode {
    ...
    public<T >T get(String name) {
        Object value = declaredPropertyOrNotFound(name, niem_domains_militaryOperations_3_2_ObservationOPEXCode.NOT_FOUND_VALUE);
        if (niem_domains_militaryOperations_3_2_ObservationOPEXCode.NOT_FOUND_VALUE!= value) {
            return ((T) value);
        } else {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof niem_domains_militaryOperations_3_2_ObservationOPEXCode) == false) {
            return false;
        }
        niem_domains_militaryOperations_3_2_ObservationOPEXCode rhs = ((niem_domains_militaryOperations_3_2_ObservationOPEXCode) other);
        ...
        for(String schema : schemaArray)
{
 schemaString = schemaString.concat(schema); 
     ...
     */
    public static niem_domains_militaryOperations_3_2_ObservationOPEXCode fromString(String s) {
        try {
            ObjectMapper objectMapper = new ObjectMapper();
            return objectMapper.readValue(s, niem_domains_militaryOperations_3_2_ObservationOPEXCode.class);
