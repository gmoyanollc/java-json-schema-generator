...
public class niem_domains_cbrn_3_2_RelativeLocationAzimuthValue {
    ...
    public<T >T get(String name) {
        Object value = declaredPropertyOrNotFound(name, niem_domains_cbrn_3_2_RelativeLocationAzimuthValue.NOT_FOUND_VALUE);
        if (niem_domains_cbrn_3_2_RelativeLocationAzimuthValue.NOT_FOUND_VALUE!= value) {
            return ((T) value);
        } else {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof niem_domains_cbrn_3_2_RelativeLocationAzimuthValue) == false) {
            return false;
        }
        niem_domains_cbrn_3_2_RelativeLocationAzimuthValue rhs = ((niem_domains_cbrn_3_2_RelativeLocationAzimuthValue) other);
        ...
        for(String schema : schemaArray)
{
 schemaString = schemaString.concat(schema); 
     ...
     */
    public static niem_domains_cbrn_3_2_RelativeLocationAzimuthValue fromString(String s) {
        try {
            ObjectMapper objectMapper = new ObjectMapper();
            return objectMapper.readValue(s, niem_domains_cbrn_3_2_RelativeLocationAzimuthValue.class);
