...
public class niem_niem_core_3_0_Identification {
    ...
    private final static String[] schemaArray = new String[] {"{\"$schema\":\"http://json-schema.org/draft-04/schema#\",\"id\":\"http://release.niem.gov/niem/niem-core/3.0/#Identification\",\"title\":\"Identification\",\"type\":\"object\",\"description\":\"A representation of an identity.\",\"version\":\"0.4.4\",\"javaType\":\"niem_niem_core_3_0_Identification\",\"properties\":{\"IdentificationID\":{\"$ref\":\"IdentificationID.json\"},\"IdentificationJurisdiction\":{\"$ref\":\"IdentificationJurisdiction.json\"},\"IdentificationAugmentationPoint\":{\"ShortName\":{\"$ref\":\"../../../tsoa/soi/tsoa-track/2.0/ShortName.json\"}}},\"additionalProperties\":false}", ""};
    ...
    public<T >T get(String name) {
        Object value = declaredPropertyOrNotFound(name, niem_niem_core_3_0_Identification.NOT_FOUND_VALUE);
        if (niem_niem_core_3_0_Identification.NOT_FOUND_VALUE!= value) {
            return ((T) value);
        } else {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof niem_niem_core_3_0_Identification) == false) {
            return false;
        }
        niem_niem_core_3_0_Identification rhs = ((niem_niem_core_3_0_Identification) other);
    ...
    public static String[] getReferenceArray() {
        return new String[] {"IdentificationID.json", "LocationCountryName.json", "../../../../niem/niem-core/3.0/TextType.json", "IdentificationJurisdiction.json", "../../../tsoa/soi/tsoa-track/2.0/ShortName.json"};
    }
        ...
        for(String schema : schemaArray)
{
 schemaString = schemaString.concat(schema); 
     ...
     */
    public static niem_niem_core_3_0_Identification fromString(String s) {
        try {
            ObjectMapper objectMapper = new ObjectMapper();
            return objectMapper.readValue(s, niem_niem_core_3_0_Identification.class);
