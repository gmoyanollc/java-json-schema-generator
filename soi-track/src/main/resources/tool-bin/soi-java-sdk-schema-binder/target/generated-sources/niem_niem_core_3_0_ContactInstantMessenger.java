...
public class niem_niem_core_3_0_ContactInstantMessenger {
    ...
    public<T >T get(String name) {
        Object value = declaredPropertyOrNotFound(name, niem_niem_core_3_0_ContactInstantMessenger.NOT_FOUND_VALUE);
        if (niem_niem_core_3_0_ContactInstantMessenger.NOT_FOUND_VALUE!= value) {
            return ((T) value);
        } else {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof niem_niem_core_3_0_ContactInstantMessenger) == false) {
            return false;
        }
        niem_niem_core_3_0_ContactInstantMessenger rhs = ((niem_niem_core_3_0_ContactInstantMessenger) other);
        ...
        for(String schema : schemaArray)
{
 schemaString = schemaString.concat(schema); 
     ...
     */
    public static niem_niem_core_3_0_ContactInstantMessenger fromString(String s) {
        try {
            ObjectMapper objectMapper = new ObjectMapper();
            return objectMapper.readValue(s, niem_niem_core_3_0_ContactInstantMessenger.class);
