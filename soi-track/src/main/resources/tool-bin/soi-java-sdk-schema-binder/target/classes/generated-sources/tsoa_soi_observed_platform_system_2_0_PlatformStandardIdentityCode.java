...
/**
 * PlatformStandardIdentityCode
 * <p>
 * A platform Standard Identity Code.
 * 
 */
...
public class tsoa_soi_observed_platform_system_2_0_PlatformStandardIdentityCode {
    ...
    public<T >T get(String name) {
        Object value = declaredPropertyOrNotFound(name, tsoa_soi_observed_platform_system_2_0_PlatformStandardIdentityCode.NOT_FOUND_VALUE);
        if (tsoa_soi_observed_platform_system_2_0_PlatformStandardIdentityCode.NOT_FOUND_VALUE!= value) {
            return ((T) value);
        } else {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof tsoa_soi_observed_platform_system_2_0_PlatformStandardIdentityCode) == false) {
            return false;
        }
        tsoa_soi_observed_platform_system_2_0_PlatformStandardIdentityCode rhs = ((tsoa_soi_observed_platform_system_2_0_PlatformStandardIdentityCode) other);
        ...
        for(String schema : schemaArray)
{
 schemaString = schemaString.concat(schema); 
     ...
     */
    public static tsoa_soi_observed_platform_system_2_0_PlatformStandardIdentityCode fromString(String s) {
        try {
            ObjectMapper objectMapper = new ObjectMapper();
            return objectMapper.readValue(s, tsoa_soi_observed_platform_system_2_0_PlatformStandardIdentityCode.class);
