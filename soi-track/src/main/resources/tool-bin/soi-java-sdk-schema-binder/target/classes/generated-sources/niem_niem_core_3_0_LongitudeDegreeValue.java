...
public class niem_niem_core_3_0_LongitudeDegreeValue {
    ...
    public<T >T get(String name) {
        Object value = declaredPropertyOrNotFound(name, niem_niem_core_3_0_LongitudeDegreeValue.NOT_FOUND_VALUE);
        if (niem_niem_core_3_0_LongitudeDegreeValue.NOT_FOUND_VALUE!= value) {
            return ((T) value);
        } else {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof niem_niem_core_3_0_LongitudeDegreeValue) == false) {
            return false;
        }
        niem_niem_core_3_0_LongitudeDegreeValue rhs = ((niem_niem_core_3_0_LongitudeDegreeValue) other);
        ...
        for(String schema : schemaArray)
{
 schemaString = schemaString.concat(schema); 
     ...
     */
    public static niem_niem_core_3_0_LongitudeDegreeValue fromString(String s) {
        try {
            ObjectMapper objectMapper = new ObjectMapper();
            return objectMapper.readValue(s, niem_niem_core_3_0_LongitudeDegreeValue.class);
