...
public class niem_niem_core_3_0_FullTelephoneNumberType {
    ...
    public<T >T get(String name) {
        Object value = declaredPropertyOrNotFound(name, niem_niem_core_3_0_FullTelephoneNumberType.NOT_FOUND_VALUE);
        if (niem_niem_core_3_0_FullTelephoneNumberType.NOT_FOUND_VALUE!= value) {
            return ((T) value);
        } else {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof niem_niem_core_3_0_FullTelephoneNumberType) == false) {
            return false;
        }
        niem_niem_core_3_0_FullTelephoneNumberType rhs = ((niem_niem_core_3_0_FullTelephoneNumberType) other);
        ...
        for(String schema : schemaArray)
{
 schemaString = schemaString.concat(schema); 
     ...
     */
    public static niem_niem_core_3_0_FullTelephoneNumberType fromString(String s) {
        try {
            ObjectMapper objectMapper = new ObjectMapper();
            return objectMapper.readValue(s, niem_niem_core_3_0_FullTelephoneNumberType.class);
