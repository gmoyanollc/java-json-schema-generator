...
public class niem_domains_militaryOperations_3_2_ObservedObjectMotion {
    ...
    public<T >T get(String name) {
        Object value = declaredPropertyOrNotFound(name, niem_domains_militaryOperations_3_2_ObservedObjectMotion.NOT_FOUND_VALUE);
        if (niem_domains_militaryOperations_3_2_ObservedObjectMotion.NOT_FOUND_VALUE!= value) {
            return ((T) value);
        } else {
        ...
        for(String schema : schemaArray)
{
 schemaString = schemaString.concat(schema); 
     ...
     */
    public static niem_domains_militaryOperations_3_2_ObservedObjectMotion fromString(String s) {
        try {
            ObjectMapper objectMapper = new ObjectMapper();
            return objectMapper.readValue(s, niem_domains_militaryOperations_3_2_ObservedObjectMotion.class);
