...
public class niem_domains_militaryOperationsRestricted_3_2_WeaponSystem {
    ...
    public<T >T get(String name) {
        Object value = declaredPropertyOrNotFound(name, niem_domains_militaryOperationsRestricted_3_2_WeaponSystem.NOT_FOUND_VALUE);
        if (niem_domains_militaryOperationsRestricted_3_2_WeaponSystem.NOT_FOUND_VALUE!= value) {
            return ((T) value);
        } else {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof niem_domains_militaryOperationsRestricted_3_2_WeaponSystem) == false) {
            return false;
        }
        niem_domains_militaryOperationsRestricted_3_2_WeaponSystem rhs = ((niem_domains_militaryOperationsRestricted_3_2_WeaponSystem) other);
        ...
        for(String schema : schemaArray)
{
 schemaString = schemaString.concat(schema); 
     ...
     */
    public static niem_domains_militaryOperationsRestricted_3_2_WeaponSystem fromString(String s) {
        try {
            ObjectMapper objectMapper = new ObjectMapper();
            return objectMapper.readValue(s, niem_domains_militaryOperationsRestricted_3_2_WeaponSystem.class);
